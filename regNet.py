...
class RegNet(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.rgb_features1 = nn.Sequential(nn.Conv2d(3, 96, 11, 4, 5),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(96, 96, 1),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(96, 96, 1),
        ...
        self.rgb_features2 = nn.Sequential(nn.Conv2d(96, 256, 5, 1, 2),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(256, 256, 1),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(256, 256, 1),
        ...
        self.rgb_features3 = nn.Sequential(nn.Conv2d(256, 384, 3, 1, 1),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(384, 384, 1),
                                           nn.ReLU(inplace=True),
                                           nn.Conv2d(384, 384, 1),
        ...
        self.fc2_transl = nn.Linear(256, 3)  # euler and quaternions
    ...
    def forward(self, img_data, lidar_data):
        ...
        img_data = F.max_pool2d(self.rgb_features1(img_data), 3, 2, 1)
        img_data = F.max_pool2d(self.rgb_features2(img_data), 3, 2, 1)
        img_data = F.max_pool2d(self.rgb_features3(img_data), 3, 2, 1)
        # Lidar branch
